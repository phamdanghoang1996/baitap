...
<div class="row">
	...
	<div class="panel panel-default" style="margin-left: -100px; width: 60%; margin-top: 50px">
				...
				<div class="panel-footer">
					...
					<a href="http://localhost:8000/doancuoiki/public/index.php/pageadmin/caidat/thaydoitaikhoan" style="color:#FFF; text-decoration: none"<button class="btn btn-primary">>Xác nhận </button></a>
					</div>
				</div>
			</div>
	</div>
